...
const Properties = ({linha, setLinha, coluna, setColuna}) => {
  ...
  return (
    <div>
      ...
      <input type="number" value={Api.board.style.gridtemplaterows} onChange={(e) => handleLinha(e)} />

      <h3>teste de colunas json</h3>
      <input type="number" value={Api.board.style.gridtemplatecolumns} onChange={(e) => handleColuna(e)} />
    </div>
  );
}
